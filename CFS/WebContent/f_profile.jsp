	...
	<div style="margin-top:0;height:1.4cm;width:100%;background-color:#C9C7C7;">
			...
			<div style="font-size:0.5cm;float:right;height:1.2cm;width:20cm;">
				<ul>
					  ...
					  <li><a class="active" href="f_profile.jsp">View Profile</a></li>
					   <li><a href="fview_feed.jsp">View Feedback</a></li>
					  <li><a href="fview_clg.jsp">View College</a></li>
					  <li><a href="fresher_home.jsp">Home</a></li>
				</ul>
			</div>
		</div>
...
try {
	...
	ResultSet rs = st.executeQuery("select * from fdata where email = '"+user+"' ");
	if (rs.next()){
		s1=rs.getString(1);
		s2=rs.getString(2);
		s4=rs.getString(3);
