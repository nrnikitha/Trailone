...
<html>
		...
		<div style="margin-top:0;height:1.4cm;width:100%;background-color:#C9C7C7;">
			...
			<div style="font-size:0.5cm;float:right;height:1.2cm;width:20cm;">
				<ul>
					  ...
					  <li><a class="active" href="stu_login.jsp">student</a></li>
	...
	<div style="height:10.5cm;width:30cm;margin-top:7%;margin-left:5%;margin-right:10%;">
			...
			<h1 align="center" style="font-size:1cm;color:#410306;font-family:Algerian;">STUDENT LOGIN</h1>
				<form action="stu_loginfun.jsp" >
					...
					<tr>
					<td>Not Registered? <a href = "stu_regis.jsp">Register!</a></td>
					</tr>
					</table>
				</form>
		</div>
