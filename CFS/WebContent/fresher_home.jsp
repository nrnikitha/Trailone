			...
			<div style="font-size:0.5cm;float:right;height:1.2cm;width:20cm;">
				<ul>
					<li><a href="logout.jsp">logout</a></li>
					  <li><a href="f_profile.jsp">View Profile</a></li>
					   <li><a  href="fview_feed.jsp">View Feedback</a></li>
					  <li><a href="fview_clg.jsp">View College</a></li>
					  <li><a class="active" href="fresher_home.jsp">Home</a></li>
				</ul>
			</div>
		</div>
...
try {
	...
	ResultSet rs = st.executeQuery("select * from fdata where email= '"+s1+"' ");
	if(rs.next()){
